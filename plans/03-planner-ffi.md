...
**Depends on:** Phase 2
**Parallelism:** 5 agents (A0--A4). Agents A5--A9 work on Phase 4 (GPU Foundation) concurrently.
...
**Status:** Not Started
**Owns:** `pg_accel/src/core/ffi/custom_scan.rs`
...
**Status:** Not Started
**Owns:** `pg_accel/src/core/ffi/planner_hooks.rs` (scan portion)
...
**Status:** Not Started
**Owns:** `pg_accel/src/core/ffi/planner_hooks.rs` (join portion, same file but distinct functions)
...
**Status:** Not Started
**Owns:** `pg_accel/src/core/ffi/custom_scan.rs` (PlanCustomPath callback)
...
**Status:** Not Started
**Owns:** `pg_accel/src/core/ffi/custom_scan.rs` (ExplainCustomScan callback)
