...
def run(args: argparse.Namespace) -> int:
    ...
    emit_suppression_summary(args.label, args.log, counts)
    if returncode != 0:
        emit_failure_summary(args.label, args.log, returncode)
    return returncode
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--log", required=True, help="raw combined stdout/stderr log path")
