...
bridge_status_fns! {
    ...
    /// Allocate shared USM for direct expression-template staging.
    pub fn pgaccel_expr_shared_alloc(
        bytes: usize,
    ...
    pub fn pgaccel_expr_template_ssbm_q1_revenue_i64_usm(
    ...
    pub fn pgaccel_expr_template_ssbm_q1_revenue_i64_usm_scratch(
        ...
        quantity_lo: i32,
        quantity_hi: i32,
        scratch_revenue_a: *mut i64,
        scratch_count_a: *mut i64,
        scratch_revenue_b: *mut i64,
        scratch_count_b: *mut i64,
        scratch_item_capacity: usize,
        out_sum: *mut i64,
        selected_count: *mut usize,
        uncertain_count: *mut usize,
    ) -> PgaccelStatus;

    pub fn pgaccel_expr_template_ssbm_q2_grouped_revenue_i64_usm(
        orderdate_col: PgaccelExprUsmCol,
        ...
        year_count: i32,
        brand_count: i32,
        out_revenue_by_group: *mut i64,
        out_count_by_group: *mut u32,
        out_group_capacity: usize,
        selected_count: *mut usize,
        uncertain_count: *mut usize,
    ) -> PgaccelStatus;

    pub fn pgaccel_expr_template_ssbm_q3_grouped_revenue_i64_usm(
        orderdate_col: PgaccelExprUsmCol,
    ...
    pub fn pgaccel_expr_template_ssbm_q4_grouped_profit_i64_usm(
        orderdate_col: PgaccelExprUsmCol,
        custkey_col: PgaccelExprUsmCol,
        suppkey_col: PgaccelExprUsmCol,
        partkey_col: PgaccelExprUsmCol,
        revenue_col: PgaccelExprUsmCol,
        supplycost_col: PgaccelExprUsmCol,
        row_count: usize,
        date_key_min: i32,
        date_year_by_offset: *const i32,
        date_match_by_offset: *const u8,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v2(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        filter_col: PgaccelExprUsmCol,
        row_count: usize,
        group_min: i32,
        group_count: i32,
        scratch_sum: *mut f64,
        ...
        out_sum_by_group: *mut f64,
        out_min_by_group: *mut f64,
        out_max_by_group: *mut f64,
        out_count_by_group: *mut u32,
        out_group_capacity: usize,
        selected_count: *mut usize,
        uncertain_count: *mut usize,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v3(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v4(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        measure_op: i32,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v5(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        measure_op: i32,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v6(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        measure_op: i32,
        ...
        measure_predicate_arg1: f64,
        measure_predicate_arg2: f64,
        filter_col: PgaccelExprUsmCol,
        row_count: usize,
        group_min: i32,
        group_count: i32,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v7(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        measure_op: i32,
        ...
        measure_predicate_lo0: f64,
        measure_predicate_hi0: f64,
        measure_predicate_lo1: f64,
        measure_predicate_hi1: f64,
        measure_predicate_lo2: f64,
        measure_predicate_hi2: f64,
        measure_predicate_lo3: f64,
        measure_predicate_hi3: f64,
        filter_col: PgaccelExprUsmCol,
        row_count: usize,
        group_min: i32,
        group_count: i32,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v8(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        measure_op: i32,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_usm_v9(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        measure_op: i32,
    ...
    pub fn pgaccel_expr_template_reduce_f64_usm(
        value_col: PgaccelExprUsmCol,
        aggregate_mask: u32,
        row_count: usize,
        out_sum: *mut f64,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_stats_pair_usm(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        row_count: usize,
        ...
        scratch_row_capacity: usize,
        out_sum_by_group: *mut f64,
        out_sumsq_by_group: *mut f64,
        out_count_by_group: *mut u32,
        out_rhs_sum_by_group: *mut f64,
        out_rhs_count_by_group: *mut u32,
        out_group_capacity: usize,
        selected_count: *mut usize,
        uncertain_count: *mut usize,
    ) -> PgaccelStatus;

    pub fn pgaccel_expr_template_resident_dense_grouped_f64_simple_sum_count_usm(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        row_count: usize,
        group_min: i32,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_mul_sum_count_usm(
        group_col: PgaccelExprUsmCol,
    ...
    pub fn pgaccel_expr_template_resident_dense_grouped_f64_pred_sum_count_usm(
        group_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        value_rhs_col: PgaccelExprUsmCol,
        filter_col: PgaccelExprUsmCol,
    ...
    pub fn pgaccel_expr_template_resident_star_dim_group_project_f64_usm(
    ...
    pub fn pgaccel_expr_template_resident_star_dim_group_compact_f64_usm(
        fact_key_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        row_count: usize,
        dim_match_by_key: *const u8,
    ...
    pub fn pgaccel_expr_template_resident_star_dim_grouped_f64_sum_count_usm(
        fact_key_col: PgaccelExprUsmCol,
        value_col: PgaccelExprUsmCol,
        row_count: usize,
        dim_match_by_key: *const u8,
    ...
    /// Count matching pairs from already device-resident outer keys.
    pub fn pgaccel_hash_join_count_device(
        ht: *const PgaccelHashTable,
