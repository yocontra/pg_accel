...
pub use store::{
    ...
    ResolvedDerivedInputs, SelectedRelation, ensure_derived_artifact, ensure_selected_relations,
    estimate_selected_relation, register_derived_artifact, resident_live_bytes, shape_digest,
