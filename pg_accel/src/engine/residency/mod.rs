...
pub use store::{
    ...
    resident_geometry_exact_snapshot_words, resident_live_bytes, resident_selected_relation_rows,
    revalidate_loaded_estimates, revalidate_planner_dependencies, shape_digest,
