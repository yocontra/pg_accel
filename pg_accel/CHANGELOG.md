...
- **extractors**: Add 1-D PG ArrayType walker (Phase 2 B3)
- **dispatch**: Wire ST_Value(rast, geometry[]) GPU dispatch arm (Phase 2 B3)
- **dispatch**: Wire h3_cells_to_multi_polygon GPU dispatch arm (Phase 2 B3)
...
- **dispatch**: Add pg_test for h3_cells_to_multi_polygon + escalate ST_Value(geometry[]) gap (Phase 2 B3)
