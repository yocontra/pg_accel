...
-- mixed geometry/geography, and Custom Scan verification.
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _tc_plan_f4 WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '87_type: float4 distance: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _tc_plan_f8 WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '87_type: float8 distance: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _tc_plan_h3 WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '87_type: h3 int cast: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _tc_plan_geom WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '87_type: ST_Contains geometry: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _tc_plan_isect WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '87_type: ST_Intersects geometry: pg_accel not in query plan';
    END IF;
END $$;
