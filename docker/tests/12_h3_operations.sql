...
-- Tests h3-pg functions accelerated via GpuH3 and BatchedEval strategies.
...
-- ========== Test 2: h3_get_resolution (GpuH3) ==========
...
-- ========== Test 3: h3_cell_to_parent (GpuH3) ==========
SET pg_accel.enabled = off;
...
-- ========== Test 5: h3_cell_to_latlng (BatchedEval) ==========
SET pg_accel.enabled = off;
...
-- ========== Test 6: h3_cell_to_boundary (BatchedEval) ==========
SET pg_accel.enabled = off;
...
\echo 'PASS: 12_h3_operations (9 tests)'
