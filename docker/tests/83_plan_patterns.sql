-- 83_plan_patterns.sql: GPU-accelerated functions in complex query structures
-- Verifies Custom Scan appears in EXPLAIN and ON/OFF results match.
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp01_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_01_cte_dwithin FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp02_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_02_subquery_where FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp03_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_03_subquery_from FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp04_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_04_subquery_select FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp05_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_05_union_all FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp06_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_06_except FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp07_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_07_intersect FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp08_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_08_correlated FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp09_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_09_insert_select FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp10_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_10_ctas FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp11_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_11_nested_3deep FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp12_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_12_lateral FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp13_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_13_window FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp14_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_14_case_when FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp15_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_15_multi_cte FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp16_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_16_group_by FAILED: pg_accel not in query plan';
    END IF;
END $$;
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM _pp21_plan WHERE line ILIKE '%custom scan%') THEN
        RAISE EXCEPTION '83_21_self_join FAILED: pg_accel not in query plan';
    END IF;
END $$;
