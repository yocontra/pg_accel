...
-- fallback semantics pg_accel forbids: nested scalar filters, h3-pg's
-- polygon holes-array signature, and NULL constants in SRF arguments.
SET pg_accel.enabled = on;
...
BEGIN
    ...
    -- h3-pg's installed polygon-fill signature includes polygon[] holes.
    ...
    LOOP
        INSERT INTO _h3_plan_guard VALUES ('h3_polygon_to_cells_signature_guard', r."QUERY PLAN");
    END LOOP;
