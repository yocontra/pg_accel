...
The four typed column-count lanes require one nullable boolean fact key and one
distinct nullable bool, int2, int8, or date input; global, filtered, joined,
...
candidate. Freeze the replacement SHA/tree and thirteen-cell population, then make a
