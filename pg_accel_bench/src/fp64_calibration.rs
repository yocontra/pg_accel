...
pub fn sizes_with_optional_cap(max_size: Option<&str>) -> Result<Vec<usize>, String> {
    let sizes = workloads::fp64_matrix::FP64_MATRIX_SIZES.to_vec();
...
mod tests {
    ...
    #[test]
    fn sizes_without_cap_returns_full_canonical_matrix() {
        let sizes = sizes_with_optional_cap(None).expect("canonical sizes");
