...
impl Workload for TopkWide {
    ...
    fn query_sql(&self) -> String {
        "SELECT * FROM bench_topk_wide ORDER BY val, id LIMIT 100".to_owned()
    }
...
mod tests {
    ...
    #[test]
    fn topk_wide_query_uses_total_order() {
        assert!(TopkWide.query_sql().contains("ORDER BY val, id LIMIT 100"));
    }
}
