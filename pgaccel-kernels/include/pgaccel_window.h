...
pgaccel_status
pgaccel_window_row_number(const uint8_t* partition_starts, /* [count] 1=new partition */
                          size_t count, int64_t* results   /* [count] output */
);
...
pgaccel_status
pgaccel_window_sum(const uint8_t* partition_starts, const double* values,
                   const uint8_t* null_mask, /* [count] 1=null, or NULL for no nulls */
                   size_t count, double* results);
...
pgaccel_status pgaccel_window_lag(const uint8_t* partition_starts, const double* values,
                                  ...
                                  double default_val, double* results,
