...
static void test_f64_basic() {
  ...
  // fp64 bbox must remain correct and available. On Metal this currently
  // uses a host fallback because the direct fp64 bbox SYCL kernel poisons
  // the bbox code object during soft-fp64 lowering.
