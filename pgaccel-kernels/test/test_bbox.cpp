...
static void test_f64_basic() {
  ...
  // Post fp64-unlock (W1/W2/W3/W4): every backend must dispatch fp64
  // bbox — soft-fp64 on Metal, native on CUDA/ROCm/L0. UNSUPPORTED is
  // now a FAIL (skip-gate deleted).
